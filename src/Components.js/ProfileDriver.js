...
function ProfileDriver() {
    ...
    const getAllData = async() => {
     ...
     const getDocument = async() => {
         ...
         await axios.post('https://hiiguest.com/get-driver', {
             ...
             setData1(response.data.documents);
             console.log(data1);
      ...
      const getOwnerComp = async() => {
          const phoneNo = state.post_id;
          await axios.post('https://hiiguest.com/get-driver', {
              phoneNo: phoneNo
          }, { headers }).then(response => {
              console.log('response ownerCompany')
              console.log(response.data.ownerCompany);
              setDataC(response.data.ownerCompany);
              console.log(dataC);
    ...
    const getVehicle = async() => {
        ...
        await axios.post('https://hiiguest.com/get-driver', {
            ...
            setData2(response.data.vehicleDetails);
            console.log(data2);
                                        ...
                                        <Table sx={{ minWidth: 650 }} aria-label="simple table" >
                                            <TableBody>
                                                ...
                                                >
                                                    ...
                                                    <TableCell style={TextColor} component="th" scope="row">
                                            <img style={imgStyle} src={`https://hiiguest.com/${data1.driverLicense}`} />
                                                ...
                                                >
                                                    ...
                                                    <TableCell style={TextColor} component="th" scope="row">
                                            <img style={imgStyle} src={`https://hiiguest.com/${data1.vehicleOwnership}`} />
